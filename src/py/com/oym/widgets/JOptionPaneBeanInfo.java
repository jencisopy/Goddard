 ...
 */
public class JOptionPaneBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( py.com.oym.widgets.JOptionPane.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_icon = 46;
    private static final int PROPERTY_ignoreRepaint = 47;
    private static final int PROPERTY_inheritsPopupMenu = 48;
    private static final int PROPERTY_initialSelectionValue = 49;
    private static final int PROPERTY_initialValue = 50;
    ...
    private static final int PROPERTY_inputValue = 55;
    ...
    private static final int PROPERTY_maxCharactersPerLineCount = 65;
    private static final int PROPERTY_maximumSize = 66;
    private static final int PROPERTY_maximumSizeSet = 67;
    private static final int PROPERTY_message = 68;
    private static final int PROPERTY_messageType = 69;
    ...
    private static final int PROPERTY_options = 80;
    private static final int PROPERTY_optionType = 81;
    ...
    private static final int PROPERTY_selectionValues = 92;
    ...
    private static final int PROPERTY_value = 104;
    ...
    private static final int PROPERTY_wantsInput = 109;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", py.com.oym.widgets.JOptionPane.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", py.com.oym.widgets.JOptionPane.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", py.com.oym.widgets.JOptionPane.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", py.com.oym.widgets.JOptionPane.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", py.com.oym.widgets.JOptionPane.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", py.com.oym.widgets.JOptionPane.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", py.com.oym.widgets.JOptionPane.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", py.com.oym.widgets.JOptionPane.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", py.com.oym.widgets.JOptionPane.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", py.com.oym.widgets.JOptionPane.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", py.com.oym.widgets.JOptionPane.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", py.com.oym.widgets.JOptionPane.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", py.com.oym.widgets.JOptionPane.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", py.com.oym.widgets.JOptionPane.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", py.com.oym.widgets.JOptionPane.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", py.com.oym.widgets.JOptionPane.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", py.com.oym.widgets.JOptionPane.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", py.com.oym.widgets.JOptionPane.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", py.com.oym.widgets.JOptionPane.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", py.com.oym.widgets.JOptionPane.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", py.com.oym.widgets.JOptionPane.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", py.com.oym.widgets.JOptionPane.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", py.com.oym.widgets.JOptionPane.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", py.com.oym.widgets.JOptionPane.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", py.com.oym.widgets.JOptionPane.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", py.com.oym.widgets.JOptionPane.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", py.com.oym.widgets.JOptionPane.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", py.com.oym.widgets.JOptionPane.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", py.com.oym.widgets.JOptionPane.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", py.com.oym.widgets.JOptionPane.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", py.com.oym.widgets.JOptionPane.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", py.com.oym.widgets.JOptionPane.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", py.com.oym.widgets.JOptionPane.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", py.com.oym.widgets.JOptionPane.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", py.com.oym.widgets.JOptionPane.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", py.com.oym.widgets.JOptionPane.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", py.com.oym.widgets.JOptionPane.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", py.com.oym.widgets.JOptionPane.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", py.com.oym.widgets.JOptionPane.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", py.com.oym.widgets.JOptionPane.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", py.com.oym.widgets.JOptionPane.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", py.com.oym.widgets.JOptionPane.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", py.com.oym.widgets.JOptionPane.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", py.com.oym.widgets.JOptionPane.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", py.com.oym.widgets.JOptionPane.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", py.com.oym.widgets.JOptionPane.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_icon] = new PropertyDescriptor ( "icon", py.com.oym.widgets.JOptionPane.class, "getIcon", "setIcon" ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", py.com.oym.widgets.JOptionPane.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", py.com.oym.widgets.JOptionPane.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_initialSelectionValue] = new PropertyDescriptor ( "initialSelectionValue", py.com.oym.widgets.JOptionPane.class, "getInitialSelectionValue", "setInitialSelectionValue" ); // NOI18N
            properties[PROPERTY_initialValue] = new PropertyDescriptor ( "initialValue", py.com.oym.widgets.JOptionPane.class, "getInitialValue", "setInitialValue" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", py.com.oym.widgets.JOptionPane.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", py.com.oym.widgets.JOptionPane.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", py.com.oym.widgets.JOptionPane.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", py.com.oym.widgets.JOptionPane.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputValue] = new PropertyDescriptor ( "inputValue", py.com.oym.widgets.JOptionPane.class, "getInputValue", "setInputValue" ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", py.com.oym.widgets.JOptionPane.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", py.com.oym.widgets.JOptionPane.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", py.com.oym.widgets.JOptionPane.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", py.com.oym.widgets.JOptionPane.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", py.com.oym.widgets.JOptionPane.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", py.com.oym.widgets.JOptionPane.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", py.com.oym.widgets.JOptionPane.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", py.com.oym.widgets.JOptionPane.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", py.com.oym.widgets.JOptionPane.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maxCharactersPerLineCount] = new PropertyDescriptor ( "maxCharactersPerLineCount", py.com.oym.widgets.JOptionPane.class, "getMaxCharactersPerLineCount", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", py.com.oym.widgets.JOptionPane.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", py.com.oym.widgets.JOptionPane.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_message] = new PropertyDescriptor ( "message", py.com.oym.widgets.JOptionPane.class, "getMessage", "setMessage" ); // NOI18N
            properties[PROPERTY_messageType] = new PropertyDescriptor ( "messageType", py.com.oym.widgets.JOptionPane.class, "getMessageType", "setMessageType" ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", py.com.oym.widgets.JOptionPane.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", py.com.oym.widgets.JOptionPane.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", py.com.oym.widgets.JOptionPane.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", py.com.oym.widgets.JOptionPane.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", py.com.oym.widgets.JOptionPane.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", py.com.oym.widgets.JOptionPane.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", py.com.oym.widgets.JOptionPane.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", py.com.oym.widgets.JOptionPane.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", py.com.oym.widgets.JOptionPane.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", py.com.oym.widgets.JOptionPane.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_options] = new PropertyDescriptor ( "options", py.com.oym.widgets.JOptionPane.class, "getOptions", "setOptions" ); // NOI18N
            properties[PROPERTY_optionType] = new PropertyDescriptor ( "optionType", py.com.oym.widgets.JOptionPane.class, "getOptionType", "setOptionType" ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", py.com.oym.widgets.JOptionPane.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", py.com.oym.widgets.JOptionPane.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", py.com.oym.widgets.JOptionPane.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", py.com.oym.widgets.JOptionPane.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", py.com.oym.widgets.JOptionPane.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", py.com.oym.widgets.JOptionPane.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", py.com.oym.widgets.JOptionPane.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", py.com.oym.widgets.JOptionPane.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", py.com.oym.widgets.JOptionPane.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", py.com.oym.widgets.JOptionPane.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_selectionValues] = new PropertyDescriptor ( "selectionValues", py.com.oym.widgets.JOptionPane.class, "getSelectionValues", "setSelectionValues" ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", py.com.oym.widgets.JOptionPane.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", py.com.oym.widgets.JOptionPane.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", py.com.oym.widgets.JOptionPane.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", py.com.oym.widgets.JOptionPane.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", py.com.oym.widgets.JOptionPane.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", py.com.oym.widgets.JOptionPane.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", py.com.oym.widgets.JOptionPane.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", py.com.oym.widgets.JOptionPane.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", py.com.oym.widgets.JOptionPane.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", py.com.oym.widgets.JOptionPane.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", py.com.oym.widgets.JOptionPane.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_value] = new PropertyDescriptor ( "value", py.com.oym.widgets.JOptionPane.class, "getValue", "setValue" ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", py.com.oym.widgets.JOptionPane.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", py.com.oym.widgets.JOptionPane.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", py.com.oym.widgets.JOptionPane.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", py.com.oym.widgets.JOptionPane.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_wantsInput] = new PropertyDescriptor ( "wantsInput", py.com.oym.widgets.JOptionPane.class, "getWantsInput", "setWantsInput" ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", py.com.oym.widgets.JOptionPane.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", py.com.oym.widgets.JOptionPane.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", py.com.oym.widgets.JOptionPane.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( py.com.oym.widgets.JOptionPane.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_createDialog18 = 18;
    private static final int METHOD_createDialog19 = 19;
    private static final int METHOD_createImage20 = 20;
    private static final int METHOD_createImage21 = 21;
    private static final int METHOD_createInternalFrame22 = 22;
    ...
    private static final int METHOD_getDesktopPaneForComponent52 = 52;
    private static final int METHOD_getFocusTraversalKeys53 = 53;
    private static final int METHOD_getFontMetrics54 = 54;
    private static final int METHOD_getFrameForComponent55 = 55;
    ...
    private static final int METHOD_getRootFrame62 = 62;
    ...
    private static final int METHOD_selectInitialValue134 = 134;
    ...
    private static final int METHOD_setRootFrame138 = 138;
    private static final int METHOD_show139 = 139;
    private static final int METHOD_show140 = 140;
    private static final int METHOD_showConfirmDialog141 = 141;
    private static final int METHOD_showConfirmDialog142 = 142;
    private static final int METHOD_showConfirmDialog143 = 143;
    private static final int METHOD_showConfirmDialog144 = 144;
    private static final int METHOD_showInputDialog145 = 145;
    private static final int METHOD_showInputDialog146 = 146;
    private static final int METHOD_showInputDialog147 = 147;
    private static final int METHOD_showInputDialog148 = 148;
    private static final int METHOD_showInputDialog149 = 149;
    private static final int METHOD_showInputDialog150 = 150;
    private static final int METHOD_showInternalConfirmDialog151 = 151;
    private static final int METHOD_showInternalConfirmDialog152 = 152;
    private static final int METHOD_showInternalConfirmDialog153 = 153;
    private static final int METHOD_showInternalConfirmDialog154 = 154;
    private static final int METHOD_showInternalInputDialog155 = 155;
    private static final int METHOD_showInternalInputDialog156 = 156;
    private static final int METHOD_showInternalInputDialog157 = 157;
    private static final int METHOD_showInternalMessageDialog158 = 158;
    private static final int METHOD_showInternalMessageDialog159 = 159;
    private static final int METHOD_showInternalMessageDialog160 = 160;
    private static final int METHOD_showInternalOptionDialog161 = 161;
    private static final int METHOD_showMessageDialog162 = 162;
    private static final int METHOD_showMessageDialog163 = 163;
    private static final int METHOD_showMessageDialog164 = 164;
    private static final int METHOD_showOptionDialog165 = 165;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_createDialog18] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("createDialog", new Class[] {java.awt.Component.class, java.lang.String.class})); // NOI18N
            methods[METHOD_createDialog18].setDisplayName ( "" );
            methods[METHOD_createDialog19] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("createDialog", new Class[] {java.lang.String.class})); // NOI18N
            methods[METHOD_createDialog19].setDisplayName ( "" );
            ...
            methods[METHOD_createInternalFrame22] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("createInternalFrame", new Class[] {java.awt.Component.class, java.lang.String.class})); // NOI18N
            methods[METHOD_createInternalFrame22].setDisplayName ( "" );
            ...
            methods[METHOD_getDesktopPaneForComponent52] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("getDesktopPaneForComponent", new Class[] {java.awt.Component.class})); // NOI18N
            methods[METHOD_getDesktopPaneForComponent52].setDisplayName ( "" );
            ...
            methods[METHOD_getFrameForComponent55] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("getFrameForComponent", new Class[] {java.awt.Component.class})); // NOI18N
            methods[METHOD_getFrameForComponent55].setDisplayName ( "" );
            ...
            methods[METHOD_getRootFrame62] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("getRootFrame", new Class[] {})); // NOI18N
            methods[METHOD_getRootFrame62].setDisplayName ( "" );
            ...
            methods[METHOD_selectInitialValue134] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("selectInitialValue", new Class[] {})); // NOI18N
            methods[METHOD_selectInitialValue134].setDisplayName ( "" );
            ...
            methods[METHOD_setRootFrame138] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("setRootFrame", new Class[] {java.awt.Frame.class})); // NOI18N
            methods[METHOD_setRootFrame138].setDisplayName ( "" );
            ...
            methods[METHOD_showConfirmDialog141] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showConfirmDialog", new Class[] {java.awt.Component.class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showConfirmDialog141].setDisplayName ( "" );
            methods[METHOD_showConfirmDialog142] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showConfirmDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class})); // NOI18N
            methods[METHOD_showConfirmDialog142].setDisplayName ( "" );
            methods[METHOD_showConfirmDialog143] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showConfirmDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class, int.class})); // NOI18N
            methods[METHOD_showConfirmDialog143].setDisplayName ( "" );
            methods[METHOD_showConfirmDialog144] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showConfirmDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class, int.class, javax.swing.Icon.class})); // NOI18N
            methods[METHOD_showConfirmDialog144].setDisplayName ( "" );
            methods[METHOD_showInputDialog145] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInputDialog", new Class[] {java.lang.Object.class})); // NOI18N
            methods[METHOD_showInputDialog145].setDisplayName ( "" );
            methods[METHOD_showInputDialog146] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInputDialog", new Class[] {java.lang.Object.class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showInputDialog146].setDisplayName ( "" );
            methods[METHOD_showInputDialog147] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInputDialog", new Class[] {java.awt.Component.class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showInputDialog147].setDisplayName ( "" );
            methods[METHOD_showInputDialog148] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInputDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showInputDialog148].setDisplayName ( "" );
            methods[METHOD_showInputDialog149] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInputDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class})); // NOI18N
            methods[METHOD_showInputDialog149].setDisplayName ( "" );
            methods[METHOD_showInputDialog150] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInputDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class, javax.swing.Icon.class, java.lang.Object[].class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showInputDialog150].setDisplayName ( "" );
            methods[METHOD_showInternalConfirmDialog151] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalConfirmDialog", new Class[] {java.awt.Component.class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showInternalConfirmDialog151].setDisplayName ( "" );
            methods[METHOD_showInternalConfirmDialog152] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalConfirmDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class})); // NOI18N
            methods[METHOD_showInternalConfirmDialog152].setDisplayName ( "" );
            methods[METHOD_showInternalConfirmDialog153] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalConfirmDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class, int.class})); // NOI18N
            methods[METHOD_showInternalConfirmDialog153].setDisplayName ( "" );
            methods[METHOD_showInternalConfirmDialog154] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalConfirmDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class, int.class, javax.swing.Icon.class})); // NOI18N
            methods[METHOD_showInternalConfirmDialog154].setDisplayName ( "" );
            methods[METHOD_showInternalInputDialog155] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalInputDialog", new Class[] {java.awt.Component.class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showInternalInputDialog155].setDisplayName ( "" );
            methods[METHOD_showInternalInputDialog156] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalInputDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class})); // NOI18N
            methods[METHOD_showInternalInputDialog156].setDisplayName ( "" );
            methods[METHOD_showInternalInputDialog157] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalInputDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class, javax.swing.Icon.class, java.lang.Object[].class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showInternalInputDialog157].setDisplayName ( "" );
            methods[METHOD_showInternalMessageDialog158] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalMessageDialog", new Class[] {java.awt.Component.class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showInternalMessageDialog158].setDisplayName ( "" );
            methods[METHOD_showInternalMessageDialog159] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalMessageDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class})); // NOI18N
            methods[METHOD_showInternalMessageDialog159].setDisplayName ( "" );
            methods[METHOD_showInternalMessageDialog160] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalMessageDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class, javax.swing.Icon.class})); // NOI18N
            methods[METHOD_showInternalMessageDialog160].setDisplayName ( "" );
            methods[METHOD_showInternalOptionDialog161] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showInternalOptionDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class, int.class, javax.swing.Icon.class, java.lang.Object[].class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showInternalOptionDialog161].setDisplayName ( "" );
            methods[METHOD_showMessageDialog162] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showMessageDialog", new Class[] {java.awt.Component.class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showMessageDialog162].setDisplayName ( "" );
            methods[METHOD_showMessageDialog163] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showMessageDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class})); // NOI18N
            methods[METHOD_showMessageDialog163].setDisplayName ( "" );
            methods[METHOD_showMessageDialog164] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showMessageDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class, javax.swing.Icon.class})); // NOI18N
            methods[METHOD_showMessageDialog164].setDisplayName ( "" );
            methods[METHOD_showOptionDialog165] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("showOptionDialog", new Class[] {java.awt.Component.class, java.lang.Object.class, java.lang.String.class, int.class, int.class, javax.swing.Icon.class, java.lang.Object[].class, java.lang.Object.class})); // NOI18N
            methods[METHOD_showOptionDialog165].setDisplayName ( "" );
            ...
            methods[METHOD_transferFocusBackward169] = new MethodDescriptor(java.awt.Component.class.getMethod("transferFocusBackward", new Class[] {})); // NOI18N
            ...
            methods[METHOD_updateUI174] = new MethodDescriptor(javax.swing.JOptionPane.class.getMethod("updateUI", new Class[] {})); // NOI18N
    ...
    private static String iconNameC16 = "/py/com/oym/widgets/icons/JOptionPane.jpg";//GEN-BEGIN:Icons
    private static String iconNameC32 = "/py/com/oym/widgets/icons/JOptionPane.jpg";
    private static String iconNameM16 = "/py/com/oym/widgets/icons/JOptionPane.jpg";
    private static String iconNameM32 = "/py/com/oym/widgets/icons/JOptionPane.jpg";//GEN-END:Icons
